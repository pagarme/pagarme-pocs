...
.then( client => {
  ...
  var cardCreationPromise = client.cards.create({
  ...
  var customerCreationPromise = client.customers.create({
    ...
    .then( values => {
      ...
      .then( transaction => console.log( transaction ), failure => console.log( failure ) );
